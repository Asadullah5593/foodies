...
export const PATH_PERMISSIONS: Record<string, string[] | null> = {
  ...
  '/admin/product-promotions': ['discounts:manage'],
  '/admin/coupons': ['discounts:manage'],
  '/admin/campaigns': ['campaigns:manage', 'cms:manage'],
  '/admin/offer-settings': ['campaigns:manage', 'discounts:manage'],
  '/admin/bank-cards': ['discounts:manage'],
  '/admin/loyalty-settings': ['loyalty:manage'],
  '/admin/invoice-templates': ['business-settings:access'],
  ...
  '/admin/notification-settings': ['notifications:manage'],
